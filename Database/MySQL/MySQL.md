...
- [Chapter 6. 인덱스](#chapter-6-인덱스)
  ...
  - [6-2 인덱스의 내부 작동](#6-2-인덱스의-내부-작동)
    - [6-2-1. 인덱스의 내부 작동 원리](#6-2-1-인덱스의-내부-작동-원리)
      - [균형 트리의 개념](#균형-트리의-개념)
      - [균형 트리의 페이지 분할](#균형-트리의-페이지-분할)
    - [6-2-2. 인덱스의 구조](#6-2-2-인덱스의-구조)
      - [클러스터형 인덱스 구성하기](#클러스터형-인덱스-구성하기)
      - [보조 인덱스 구성하기](#보조-인덱스-구성하기)
      - [인덱스에서 데이터 검색하기](#인덱스에서-데이터-검색하기)
  - [6-3. 인덱스의 실제 사용](#6-3-인덱스의-실제-사용)
    - [6-3-1. 인덱스 생성과 제거](#6-3-1-인덱스-생성과-제거)
      - [인덱스 생성 문법](#인덱스-생성-문법)
      - [인덱스 제거 문법](#인덱스-제거-문법)
    - [6-3-2. 인덱스 생성과 제거 실습](#6-3-2-인덱스-생성과-제거-실습)
      - [인덱스 생성과 제거 실습](#인덱스-생성과-제거-실습)
      - [인덱스의 활용 실습](#인덱스의-활용-실습)
